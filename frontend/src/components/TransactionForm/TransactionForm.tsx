...
const TransactionForm = () => {
  ...
  const onSubmit = async (data: FormData) => {
    const mutation = `
  mutation AddTransaction($transactionDTO: TransactionDTOInput!) {
  ...
  return (
    ...
    >
      ...
      <div className={styles.formGroup}>
        <label htmlFor="amount-input">Kwota:</label>
        <input
          id="amount-input"
          type="number"
          step="0.01"
      ...
      <div className={styles.formGroup}>
        <label htmlFor="tags-input">Tagi:</label>
        <input
          id="tags-input"
          type="text"
          {...register("tags", {
            ...
            maxLength: {
              value: 50,
              message: "Tagi muszą mieć najwyżej 50 znaków",
            },
          })}
      ...
      <div className={styles.formGroup}>
        <label htmlFor="notes-textarea">Notatki:</label>
        <textarea
          id="notes-textarea"
          {...register("notes", {
            maxLength: {
